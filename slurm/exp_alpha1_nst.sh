...
#SBATCH --account=lsfb
#
#SBATCH --output=./out/alpha1_nst/%A_%a.out
...
config_files=(
  "../config/alpha1_nst/dgs_io.yaml"
  "../config/alpha1_nst/dgs_io_off.yaml"
  "../config/alpha1_nst/lsfb_io.yaml"
  "../config/alpha1_nst/lsfb_io_off.yaml"
)
