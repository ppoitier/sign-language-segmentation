...
config_files=(
  "../config/improv2/dgs_pn_mstcn_4s_10l_io_ce.yaml"
  "../config/improv2/dgs_pn_mstcn_4s_10l_io_fl.yaml"
  "../config/improv2/dgs_pn_mstcn_4s_10l_io_ce_off.yaml"
  "../config/improv2/dgs_pn_mstcn_4s_10l_io_fl_off.yaml"
)
